...
function renderAuth(){const signed=!!authUser;$('auth-user').hidden=!signed;$('logout').hidden=!signed;$('auth-user').textContent=signed?authUser.name||authUser.email:'';$('sync').textContent=signed?'↻ Atualizar e-mails':'🔒 Atualizar e-mails';window.renderCorrections?.();}
